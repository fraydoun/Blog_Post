    ...
    public function store(Request $request)
    {
        ...
        $validate = Validator::make(
            $input_data,[
                ...
                'short_content.required' => 'متن   کوتاه باید وارد شود',
                'short_content.regex' => 'متن   کوتاه بیشتر از 500 حرف نباشد',
                'content.required' => '  متن مقاله باید وارد شود',
                'content.regex' => '  متن مقاله بیشتر از 10000 حرف نباشد',
        ...
        public function update(Request $request, $id)
        {
            ...
            $validate = Validator::make(
                ...
                [
                    ...
                    'content' => 'required|max:10000',
                    'tags' => 'required',
                    'newPhoto' => 'mimes:jpg,jpeg,png,bmp|max:5120',
                    'blog_category_id' => 'required',
                    'admin_id' => 'required',
                    ...
                    'blog_category_id.required' => ' دسته بندی را انتخاب کنید',
                    'admin_id.required' => ' نویسنده را انتخاب کنید',
                    'newPhoto.mimes' => '  تنها عکس با فرمت (jpg,jpeg,png,bmp)را میتوانید انتخاب کنید',
                    'newPhoto.max' => 'عکس نباید بیشتر از 5 میگابیت باشد',
                    'view_counter.required' =>'تعداد بازدید را وارد کنید'
                    ]
                );
                if ($validate->fails()) {
                    return redirect()->back()->withInput()->withErrors($validate->errors());
                ...
                $blogpost->view_counter = $request->view_counter;
